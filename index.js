document.addEventListener('DOMContentLoaded', function () {
    ...
    class Quixo {
        constructor() {
            ...
            this.posicionUsuario = 0;
            this.secuencia = [];
            this.velocidad = 1000; // ← AUMENTADO para que se ilumine más tiempo
            this.botonesBloqueados = true;
            this.sonidosBoton = [];
            this.inactividadTimeout = null;
            this.mostrandoSecuencia = false; // ← NUEVA BANDERA para evitar ejecuciones múltiples
        ...
        reiniciarJuego() {
            ...
            this.posicionUsuario = 0;
            this.botonesBloqueados = true;
            this.mostrandoSecuencia = false; // ← RESETEAR bandera
            ...
            if (this.secuencia[this.posicionUsuario] === indice) {
                ...
                if (this.posicionUsuario > this.rondaActual) {
                    ...
                    if (this.rondaActual < this.secuencia.length) {
                        ...
                        // ← BLOQUEAR botones antes de mostrar secuencia
                        this.botonesBloqueados = true;
                        
                        setTimeout(() => {
                            // ← VERIFICAR que no haya otra secuencia corriendo
        ...
        mostrarSecuencia() {
            // ← EVITAR que se ejecute si ya hay una secuencia corriendo
            if (this.mostrandoSecuencia) {
                return;
            }

            this.mostrandoSecuencia = true; // ← ACTIVAR bandera
            this.botonesBloqueados = true; // ← BLOQUEAR botones durante la secuencia
            clearTimeout(this.inactividadTimeout);
            ...
            const secuenciaInterval = setInterval(() => {
                ...
                if (indiceSecuencia <= this.rondaActual) {
                    ...
                    clearInterval(secuenciaInterval);
                    this.botonesBloqueados = false; // ← DESBLOQUEAR botones al terminar
                    this.posicionUsuario = 0;
                    this.mostrandoSecuencia = false; // ← DESACTIVAR bandera
